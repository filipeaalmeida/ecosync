...
SERVICE_ACCOUNT_NAME="${PROJECT_SHORT_NAME}-${ENVIRONMENT}-sa"
SERVICE_ACCOUNT_DISPLAY_NAME="${PROJECT_FULL_NAME} Service Account"
GCLOUD_CONFIG_NAME="${PROJECT_SHORT_NAME}-${ENVIRONMENT}-config"
...
echo "4. Faça o deploy do backend usando cloudbuild.yaml"
